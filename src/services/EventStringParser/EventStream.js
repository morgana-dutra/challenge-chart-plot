/*
This class represents an EventStream with the following fields:
Select: variables that could be plotted; 
Group: splits the same variable in different series;
Span: events to be ignored.
*/
